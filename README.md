...
* Dark / light theme with Appearance settings (per-theme colors, canvas + window chrome, corner presets, UI font with custom file imports, tab rail position), custom frameless titlebar with draggable tabs (titles follow design names, dockable top / bottom / left / right with collapsible side rails, hideable chrome)
